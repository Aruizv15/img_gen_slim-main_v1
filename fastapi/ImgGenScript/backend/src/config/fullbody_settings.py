...
class FullbodySettings(BaseSettings):
    """
    Configuration settings for full body image generation.

    This class encapsulates all the parameters specific to the full body batch
    ...
    Attributes:
        ...
        k0_steps (int): The number of steps for the zero KSampler.
        k0_cfg (float): The CFG scale for the zero KSampler.
        k0_sampler_name (str): The sampler name for the zero KSampler.
        k0_scheduler (str): The scheduler for the zero KSampler.
    ...
    # --- ControlNet (suave, pasada de identidad -- nodo 48) ---
